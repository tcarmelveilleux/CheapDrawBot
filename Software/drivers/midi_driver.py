...
# -*- coding: utf-8 -*-
"""
Midi-based input control for drawbot_gui
    ...
    def process(self):
        while self.running:
            ...
            if value != self.last_values[control]:
                ...
                event = {"ts": ts, "axis": axis_config["name"], "value": event_value}
...
if __name__ == '__main__':
    ...
    try:
        ...
        driver = MidiRobotDriver(midi_port, 0, event_handler, axes_configs)
        while True:
            time.sleep(0.1)
